 ...
 * @author USER
 */
public class VistaSinglePlayer extends javax.swing.JFrame {

    /**
     * Creates new form vistaSinglePlayer
     */
    public VistaSinglePlayer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("Single Player");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaSinglePlayer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaSinglePlayer().setVisible(true);
            }
        });
    }
